...
void ImGui::TabItemBackground(ImDrawList* draw_list, const ImRect& bb, ImGuiTabItemFlags flags, ImU32 col)
{
    ...
    draw_list->PathLineTo(ImVec2(bb.Min.x, y2));                                              // left base
    ...
    draw_list->PathLineTo(ImVec2(bb.Max.x, y2));                                              // right base
    ...
    {
        draw_list->PathArcTo(ImVec2(bb.Min.x - rounding + 0.5f, y2 - rounding - 0.5f), rounding, IM_PI * 0.5, 0.0f);
        draw_list->PathArcToFast(ImVec2(bb.Min.x + rounding + 0.5f, y1 + rounding + 0.5f), rounding, 6, 9);
        draw_list->PathArcToFast(ImVec2(bb.Max.x - rounding - 0.5f, y1 + rounding + 0.5f), rounding, 9, 12);
        draw_list->PathArcTo(ImVec2(bb.Max.x + rounding + 0.5f, y2 - rounding - 0.5f), rounding, IM_PI, IM_PI * 0.5);
